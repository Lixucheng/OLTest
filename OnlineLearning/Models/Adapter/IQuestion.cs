...
{
    public class IQuestion : IAdapter
    {
        ...
        /// <returns></returns>
        public int Add(string content, string aop, string bop, string cop, string dop, string correctop, string image,
            int score)
        {
        ...
        /// <param name="score"></param>
        /// <returns></returns>
        public bool Update(int keyid, string content, string aop, string bop, string cop, string dop, string correctop,
            string image, int score)
        {
            var question = Db.Question.Find(keyid);
            if (question == null)
            {
        ...
        /// <param name="keyid">主键</param>
        /// <returns></returns>
        public Question Find(int keyid)
        {
            var question = Db.Question.Find(keyid);
            if (question == null)
            {
